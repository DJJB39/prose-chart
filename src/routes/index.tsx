...
function Phase1Report() {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="mx-auto max-w-[880px] px-8 py-14">
        <article ref={reportRef} className="bg-paper">
          ...
          >
            ...
            <p className="mb-6 max-w-[58ch] font-serif text-[19px] leading-[1.4] text-ink">
              Monthly revenue across the twenty-four months to June 2025. The chart shows the
              trajectory and where it accelerates.
            </p>
            <LineChart data={chartData} yFormat="currency" xTickFormatter={formatMonth} />
          </section>

          <footer className="mt-16 border-t border-ink/10 pt-6 text-[11px] uppercase tracking-[0.2em] text-ink-muted">
